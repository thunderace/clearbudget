...
?>
<h2><img src="style/icons/page_white_text.png"/> <?php echo $keys->pageTitle_UploadCSV; ?><br/></h2>
...
<table class="tableReport">
  ...
  <td style="width: 350px">
    ...
    <input name="action" id="action" value="uploadCSVSubmit" type="hidden" />
    <input name="datafile"  id="fileToUpload"  type="file" size="60"/><br/>
    <strong><?php echo $keys->text_CSVFieldsDefaultOrder; ?></strong>
    
  </td>
  <td style="width: 300px">
    <?php echo $keys->text_CSVFieldsInFirstLine; ?>: <input type="radio" name="CSVFieldsInFirstLine" id="CSVFieldsInFirstLine" value="1" checked><?php echo $keys->text_yes;?> <input type="radio" name="CSVFieldsInFirstLine" id="CSVFieldsInFirstLine" value="0"><?php echo $keys->text_no;?>
    <br/>
